          ...
          <div>
            ...
            <p className="mt-4 flex justify-center">
              <a
                ...
                className="inline-flex rounded p-1 opacity-90 outline-none transition-opacity hover:opacity-100 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-primary-dark"
                aria-label="Fale com a Aurya Hub no WhatsApp"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  className="h-7 w-7 fill-current text-white sm:h-8 sm:w-8"
                  aria-hidden
                >
